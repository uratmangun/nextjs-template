/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e07fcb7087f02d6eac9488c3513ee597)
// Runtime types generated with workerd@1.20260317.1 2026-03-28 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* nextjs-template */;
	}
}
